...
# <img src="./image/ktlogo.gif" alt="Logo" width="24">minerproxy
...
### 👉 **Linux安装**
   ...
   ```sh
     bash <(curl -s -L https://github.com/mc-miner/minerproxy/raw/main/install.sh)
   ```
...
### 👉 **Other issues**
   ...
   <p>&emsp;&emsp;这是一个免费软件，不收取任何费用。从技术角度来看，它只需要终端设备计算能力的0.1%作为技术回报。</p>
